...
class DatabaseRepository(private val productDAO: ProductDAO): ProductDAO {
    ...
    val listOfProductsMock = mutableListOf(
        Product(1, "Maçã", "Vermelha", 0,3.0f, R.mipmap.ic_apple),
        Product(2, "Pêra", "Pera-d'água", 0, 2.5f, R.mipmap.ic_pear),
        Product(3, "Banana", "Banana nanica", 0,4.5f, R.mipmap.ic_banana),
        Product(4, "Abacaxi ", "IMPERIAL", 0,6.5f, R.mipmap.ic_pineapple),
        Product(5, "Manga", "Manga rosa", 0,1.5f, R.mipmap.ic_mango)
    )
